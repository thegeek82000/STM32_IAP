/**
  ...
  * @file    STM32L4xx_IAP/IAP_Binary_Template/readme.txt 
...
@par Directory contents 
 ...
 - "STM32L4xx_IAP/IAP_Binary_Template/EWARM": This folder contains a pre-configured project 
                                          file that produces a binary image of SysTick 
                                          example to be loaded with IAP.
                                          
 - "STM32L4xx_IAP/IAP_Binary_Template/MDK-ARM": This folder contains a pre-configured project 
                                          file that produces a binary image of SysTick 
                                          example to be loaded with Keil.

 - "STM32L4xx_IAP/IAP_Binary_Template/Inc": contains the binary_template firmware header files 
     - STM32L4xx_IAP/IAP_Binary_Template/Inc/stm32l4xx_hal_conf.h  Library Configuration file
     - STM32L4xx_IAP/IAP_Binary_Template/Inc/stm32l4xx_it.h      Header for stm32l0xx_it.c
     - STM32L4xx_IAP/IAP_Binary_Template/Inc/main.h              Header for main.c

 - "STM32L4xx_IAP/IAP_Binary_Template/Src": contains the binary_template firmware source files 
     - STM32L4xx_IAP/IAP_Binary_Template/Src/main.c              Main program
     - STM32L4xx_IAP/IAP_Binary_Template/Src/stm32l4xx_it.c      Interrupt handlers
     - STM32L4xx_IAP/IAP_Binary_Template/Src/system_stm32l4xx.c  STM32L0xx system source file

@note The "system_stm32l4xx.c" is generated by an automatic clock configuration 
...
In order to load the SysTick example with the IAP, you must do the following:
 ...
 - MDK-ARM:
    ...
    - A binary file "STM32L476G_EVAL_SysTick.bin" will be generated under "STM32L476G_EVAL" folder. 
    - Finally load this image with IAP application
