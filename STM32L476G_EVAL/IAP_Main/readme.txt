/**
  @page STM32L4xx_IAP AN4657 STM32L4xx In-Application Programming using the USART Readme file
  
  @verbatim
  ******************** (C) COPYRIGHT 2015 STMicroelectronics *******************
  * @file    STM32L4xx_IAP/IAP_Main/readme.txt 
  * @author  MCD Application Team
  * @version 1.0.0
  * @date    8-April-2015
  * @brief   Description of implementation of the AN4657 (in-application programming
  *          using the USART (IAP)) on STM32L4xx devices.
  ******************************************************************************
  *
...
@par Directory contents
 ...
 - "STM32L4xx_IAP/IAP_Main/Inc": contains the IAP firmware header files 
    - STM32L4xx_IAP/IAP_Main/Inc/main.h              The main include file of the project.
    - STM32L4xx_IAP/IAP_Main/Inc/common.h            This file provides all the headers of the common functions.
    - STM32L4xx_IAP/IAP_Main/Inc/flash_if.h          This file provides all the firmware 
                                                     function headers of the flash_if.c file.
    - STM32L4xx_IAP/IAP_Main/Inc/menu.h              This file provides all the firmware
                                                     function headers of the menu.c file.
    - STM32L4xx_IAP/IAP_Main/Inc/ymodem.h            This file provides all the firmware
                                                     function headers of the ymodem.c file.
    - STM32L4xx_IAP/IAP_Main/Inc/stm32l4xx_hal_conf.h  Library Configuration file
    - STM32L4xx_IAP/IAP_Main/Inc/stm32l4xx_it.h      Header for stm32l4xx_it.c

 - "STM32L4xx_IAP/IAP_Main/MDK-ARM": contains pre-configured project for MDK-ARM toolchain

 - "STM32L4xx_IAP/IAP_Main/EWARM": contains pre-configured project for EWARM toolchain

 - "STM32L4xx_IAP/IAP_Main/Src": contains the IAP firmware source files
    - STM32L4xx_IAP/IAP_Main/Src/main.c              Main program
    - STM32L4xx_IAP/IAP_Main/Src/stm32l4xx_it.c      Interrupt handlers
    - STM32L4xx_IAP/IAP_Main/Src/stm32l4xx_hal_msp.c Microcontroller specific packages
                                                     initialization file.
    - STM32L4xx_IAP/IAP_Main/Src/flash_if.c          The file contains write, erase and disable
                                                     write protection of the internal Flash
                                                     memory.
    - STM32L4xx_IAP/IAP_Main/Src/menu.c              This file contains the menu to select
    ...
    - STM32L4xx_IAP/IAP_Main/Src/common.c            This file provides functions related to
                                                     read/write from/to USART peripheral
    - STM32L4xx_IAP/IAP_Main/Src/ymodem.c            This file provides all the firmware functions
                                                     related to the ymodem protocol.
    - STM32L4xx_IAP/IAP_Main/Src/system_stm32l4xx.c  STM32L4xx system source file

@par Hardware and Software environment

  - This example runs on STM32L4xx Ultra Low Power Devices.
...
In order to make the program work, you must do the following:
  ...
  1. Generate a binary image for the program provided in the 
     "STM32L4xx_IAP/IAP_Binary_Template" project directory. 
